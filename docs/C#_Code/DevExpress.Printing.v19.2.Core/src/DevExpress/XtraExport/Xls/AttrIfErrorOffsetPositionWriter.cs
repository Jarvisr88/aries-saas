namespace DevExpress.XtraExport.Xls
{
    ...
    public class AttrIfErrorOffsetPositionWriter : IOffsetPositionWriter
    {
        private long startPosition;
        private int offsetPositionThingsCounter;

        public AttrIfErrorOffsetPositionWriter(long startPosition, int offsetPositionThingsCounter)
        {
