namespace DevExpress.Utils.Design
{
    ...
    public class DocxAllowFloatingPicturesConverter : BooleanTypeConverter
    {
        ...
        private bool GetOptionsDisableValue(ITypeDescriptorContext context)
        {
            ...
            return ((instance == null) || ((instance.ExportModeBase != ExportModeBase.SingleFilePageByPage) || instance.TableLayout));
        }
