namespace DevExpress.XtraPrinting
{
    ...
    public class XlsExportOptionsEx : XlsExportOptions, IDataAwareExportOptions
    {
        ...
        public XlsExportOptionsEx(TextExportMode textExportMode) : base(textExportMode)
        {
            this.showDataValidationErrorMessage = true;
            this.Init();
        }
        ...
        {
            get => 
                DevExpress.XtraPrinting.WorkbookColorPaletteCompliance.AdjustColorsToDefaultPalette;
            set
            {
            }
        }
