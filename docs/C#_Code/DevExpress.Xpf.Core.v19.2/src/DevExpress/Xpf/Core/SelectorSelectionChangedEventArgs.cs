namespace DevExpress.Xpf.Core
{
    ...
    public class SelectorSelectionChangedEventArgs : RoutedEventArgs
    {
        ...
        public SelectorSelectionChangedEventArgs(RoutedEvent routedEvent, IEnumerable<object> removedItems, IEnumerable<int> removedIndexes, IEnumerable<object> addedItems, IEnumerable<int> addedIndexes) : base(routedEvent)
        {
            this.Init(removedItems, removedIndexes, addedItems, addedIndexes);
        }

        public SelectorSelectionChangedEventArgs(RoutedEvent routedEvent, object source, IEnumerable<object> removedItems, IEnumerable<int> removedIndexes, IEnumerable<object> addedItems, IEnumerable<int> addedIndexes) : base(routedEvent, source)
        {
            this.Init(removedItems, removedIndexes, addedItems, addedIndexes);
        }
        ...
        {
            public static readonly SelectorSelectionChangedEventArgs.<>c <>9 = new SelectorSelectionChangedEventArgs.<>c();
