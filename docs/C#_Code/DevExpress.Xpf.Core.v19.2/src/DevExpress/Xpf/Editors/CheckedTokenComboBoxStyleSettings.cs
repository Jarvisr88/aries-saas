namespace DevExpress.Xpf.Editors
{
    ...
    public class CheckedTokenComboBoxStyleSettings : CheckedComboBoxStyleSettings, ITokenStyleSettings
    {
        ...
        public static readonly DependencyProperty FilterOutSelectedTokensProperty;
        ...
        static CheckedTokenComboBoxStyleSettings()
        {
            ...
            FilterOutSelectedTokensProperty = DependencyProperty.Register("FilterOutSelectedTokens", typeof(bool), ownerType, new FrameworkPropertyMetadata(true));
        }

        bool ITokenStyleSettings.GetFilterOutSelectedTokens() => 
            this.FilterOutSelectedTokens;
        ...
        {
            get => 
                (bool) base.GetValue(FilterOutSelectedTokensProperty);
            set => 
                base.SetValue(FilterOutSelectedTokensProperty, value);
        }
