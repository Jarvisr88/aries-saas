namespace Devart.Common
{
    ...
    internal sealed class a3
    {
        ...
        internal static string a(object A_0)
        {
            ...
            {
                throw new InvalidOperationException(av.a("ConvertFailed", A_0.GetType(), typeof(string)), exception);
            }
            return str;
        }
        ...
        internal static int b(object A_0)
        {
            ...
            {
                throw new InvalidOperationException(av.a("ConvertFailed", A_0.GetType(), typeof(int)), exception);
            }
            return num;
        }
        ...
        internal static bool c(object A_0)
        {
            ...
            if (str == null)
            {
                ...
                {
                    throw new InvalidOperationException(av.a("ConvertFailed", A_0.GetType(), typeof(bool)), exception);
                }
                return flag;
            }
