namespace DevExpress.Office.Drawing
{
    ...
    internal class TextLine
    {
        ...
        {
            if ((trimming != StringTrimming.None) && ((this.Lines.Draw != null) && ((this.TextWidth > drawBoundsWidth) || wordWrap)))
            {
                this.HasElipsis = this.GetIsTrimmingElipsis(trimming);
                int drawWidth = drawBoundsWidth - this.ElipsisWidth;
        ...
        public int LineWidth =>
            (this.TextWidth + this.ElipsisWidth) + this.Text2Width;
