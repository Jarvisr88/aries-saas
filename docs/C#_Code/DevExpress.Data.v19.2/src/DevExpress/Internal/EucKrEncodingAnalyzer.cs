namespace DevExpress.Internal
{
    ...
    public class EucKrEncodingAnalyzer : EncodingAnalyzer
    {
        ...
        static EucKrEncodingAnalyzer()
        {
            ...
            numArray1[0x10] = Pack4Bits(0, 0, 0, 0, 0, 0, 0, 0);
            numArray1[0x11] = Pack4Bits(0, 0, 0, 0, 0, 0, 0, 0);
            numArray1[0x12] = Pack4Bits(0, 0, 0, 0, 0, 0, 0, 0);
            numArray1[0x13] = Pack4Bits(0, 0, 0, 0, 0, 0, 0, 0);
            numArray1[20] = Pack4Bits(0, 2, 2, 2, 2, 2, 2, 2);
            numArray1[0x15] = Pack4Bits(2, 2, 2, 2, 2, 3, 3, 3);
            numArray1[0x16] = Pack4Bits(2, 2, 2, 2, 2, 2, 2, 2);
            numArray1[0x17] = Pack4Bits(2, 2, 2, 2, 2, 2, 2, 2);
            numArray1[0x18] = Pack4Bits(2, 2, 2, 2, 2, 2, 2, 2);
            numArray1[0x19] = Pack4Bits(2, 3, 2, 2, 2, 2, 2, 2);
            numArray1[0x1a] = Pack4Bits(2, 2, 2, 2, 2, 2, 2, 2);
            numArray1[0x1b] = Pack4Bits(2, 2, 2, 2, 2, 2, 2, 2);
            numArray1[0x1c] = Pack4Bits(2, 2, 2, 2, 2, 2, 2, 2);
            numArray1[0x1d] = Pack4Bits(2, 2, 2, 2, 2, 2, 2, 2);
            numArray1[30] = Pack4Bits(2, 2, 2, 2, 2, 2, 2, 2);
            numArray1[0x1f] = Pack4Bits(2, 2, 2, 2, 2, 2, 2, 0);
            classTable = numArray1;
            stateTable = new int[] { Pack4Bits((int) EAState.Error, (int) EAState.Start, 3, (int) EAState.Error, (int) EAState.Error, (int) EAState.Error, (int) EAState.Error, (int) EAState.Error), Pack4Bits((int) EAState.ItsMe, (int) EAState.ItsMe, (int) EAState.ItsMe, (int) EAState.ItsMe, (int) EAState.Error, (int) EAState.Error, (int) EAState.Start, (int) EAState.Start) };
            int[] numArray3 = new int[4];
            numArray3[1] = 1;
            numArray3[2] = 2;
            charLenTable = numArray3;
        }
