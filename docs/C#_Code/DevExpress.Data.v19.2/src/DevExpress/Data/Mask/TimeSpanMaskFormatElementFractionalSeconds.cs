namespace DevExpress.Data.Mask
{
    ...
    public class TimeSpanMaskFormatElementFractionalSeconds : TimeSpanMaskFormatElementEditable
    {
        public TimeSpanMaskFormatElementFractionalSeconds(string mask, bool hideOnNull = false);
