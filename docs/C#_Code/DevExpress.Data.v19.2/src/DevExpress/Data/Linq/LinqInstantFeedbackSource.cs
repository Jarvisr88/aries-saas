namespace DevExpress.Data.Linq
{
    ...
    [DXToolboxItem(true), ToolboxTabName("DX.19.2: Data & Analytics"), Description("A data source that binds controls to any queryable source ('LINQ to SQL Classes') in Instant Feedback Mode."), DefaultEvent("GetQueryable"), ToolboxBitmap(typeof(ResFinder), "Bitmaps256.LinqInstantFeedbackSource.bmp"), Designer("DevExpress.Design.InstantFeedbackSourceDesigner, DevExpress.Design.v19.2, Version=19.2.9.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a")]
    public class LinqInstantFeedbackSource : Component, IListSource, IDXCloneable
    {
        ...
        [DefaultValue(""), Category("Data"), Description("Specifies how data source contents are sorted by default, when sort order is not specified by the bound control."), Editor("DevExpress.Design.InstantFeedbackSourceDefaultSortingEditor, DevExpress.Design.v19.2, Version=19.2.9.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a", typeof(UITypeEditor))]
        public string DefaultSorting { get; set; }

        [DefaultValue(false), Category("Data"), Description("Specifies whether elements retrieved by the LinqInstantFeedbackSource's queryable source are thread-safe.")]
