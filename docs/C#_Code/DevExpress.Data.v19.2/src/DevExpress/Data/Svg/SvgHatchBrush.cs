namespace DevExpress.Data.Svg
{
    ...
    public class SvgHatchBrush : SvgBrush
    {
        private readonly SvgPatternDefinition patternDefinition;

        public SvgHatchBrush(Color color1, Color color2);
        public SvgHatchBrush(Color color1, Color color2, SvgGradientUnits units);
        [IteratorStateMachine(typeof(SvgHatchBrush.<ExportData>d__6))]
        ...
        [CompilerGenerated]
        private sealed class <ExportData>d__6 : IEnumerable<SvgDefinition>, IEnumerable, IEnumerator<SvgDefinition>, IDisposable, IEnumerator
        {
