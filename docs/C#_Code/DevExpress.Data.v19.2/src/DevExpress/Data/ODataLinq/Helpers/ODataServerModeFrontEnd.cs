namespace DevExpress.Data.ODataLinq.Helpers
{
    ...
    public class ODataServerModeFrontEnd : IListServer, IList, ICollection, IEnumerable, IListServerHints, IBindingList, ITypedList, IDXCloneable
    {
        public readonly IODataServerModeFrontEndOwner Owner;
