namespace Devart.Common
{
    ...
    internal class l : PropertyDescriptor
    {
        private Type a;
        private Type b;
        private bool c;
        ...
        public l(string A_0, Type A_1, Type A_2, bool A_3, Attribute[] A_4) : base(A_0, A_4)
        {
            this.a = A_1;
            this.b = A_2;
            this.c = A_3;
            ...
            for (int i = 0; i < A_4.Length; i++)
            {
                ...
                {
                    this.e = ((DisplayNameAttribute) attribute).DisplayName;
                    return;
                }
            }
        }
