...
DROP PROCEDURE IF EXISTS customer_insurance_fixrank;

-- Create converted procedure
BEGIN
...
-- Drop existing procedure if it exists
DROP PROCEDURE IF EXISTS fixInvoicePolicies;
...
-- Drop existing procedure if it exists
DROP PROCEDURE IF EXISTS fixOrderPolicies;
...
-- Drop existing procedure if it exists
DROP PROCEDURE IF EXISTS fix_serial_transactions;
...
-- Drop existing procedure if it exists
DROP PROCEDURE IF EXISTS internal_inventory_transfer;
...
-- Drop existing procedure if it exists
DROP PROCEDURE IF EXISTS InventoryItem_Clone;
...
-- Drop existing procedure if it exists
DROP PROCEDURE IF EXISTS inventory_adjust_2;
...
-- Drop existing procedure if it exists
DROP PROCEDURE IF EXISTS inventory_order_refresh;
...
-- Drop existing procedure if it exists
DROP PROCEDURE IF EXISTS inventory_po_refresh;
...
-- Drop existing procedure if it exists
DROP PROCEDURE IF EXISTS inventory_refresh;
...
-- Drop existing procedure if it exists
DROP PROCEDURE IF EXISTS inventory_transaction_add_adjustment;
...
-- Drop existing procedure if it exists
DROP PROCEDURE IF EXISTS inventory_transaction_order_cleanup;
...
-- Drop existing procedure if it exists
DROP PROCEDURE IF EXISTS inventory_transaction_order_refresh;
...
-- Drop existing procedure if it exists
DROP PROCEDURE IF EXISTS inventory_transaction_po_refresh;
...
-- Drop existing procedure if it exists
DROP PROCEDURE IF EXISTS InvoiceDetails_AddAutoSubmit;
...
-- Drop existing procedure if it exists
DROP PROCEDURE IF EXISTS InvoiceDetails_AddPayment;
...
-- Drop existing procedure if it exists
DROP PROCEDURE IF EXISTS InvoiceDetails_AddSubmitted;
...
-- Drop existing procedure if it exists
DROP PROCEDURE IF EXISTS InvoiceDetails_InternalAddAutoSubmit;
...
-- Drop existing procedure if it exists
DROP PROCEDURE IF EXISTS InvoiceDetails_InternalAddSubmitted;
...
-- Drop existing procedure if it exists
DROP PROCEDURE IF EXISTS InvoiceDetails_InternalReflag;
...
-- Drop existing procedure if it exists
DROP PROCEDURE IF EXISTS InvoiceDetails_InternalWriteoffBalance;
...
-- Drop existing procedure if it exists
DROP PROCEDURE IF EXISTS InvoiceDetails_RecalculateInternals;
...
-- Drop existing procedure if it exists
DROP PROCEDURE IF EXISTS InvoiceDetails_RecalculateInternals_Single;
...
-- Drop existing procedure if it exists
DROP PROCEDURE IF EXISTS InvoiceDetails_Reflag;
...
-- Drop existing procedure if it exists
DROP PROCEDURE IF EXISTS InvoiceDetails_WriteoffBalance;
...
-- Drop existing procedure if it exists
DROP PROCEDURE IF EXISTS Invoice_AddAutoSubmit;
...
-- Drop existing procedure if it exists
DROP PROCEDURE IF EXISTS Invoice_AddSubmitted;
...
-- Drop existing procedure if it exists
DROP PROCEDURE IF EXISTS Invoice_InternalReflag;
...
-- Drop existing procedure if it exists
DROP PROCEDURE IF EXISTS Invoice_InternalUpdateBalance;
...
-- Drop existing procedure if it exists
DROP PROCEDURE IF EXISTS Invoice_InternalUpdatePendingSubmissions;
...
-- Drop existing procedure if it exists
DROP PROCEDURE IF EXISTS Invoice_Reflag;
...
-- Drop existing procedure if it exists
DROP PROCEDURE IF EXISTS Invoice_UpdateBalance;
...
-- Drop existing procedure if it exists
DROP PROCEDURE IF EXISTS Invoice_UpdatePendingSubmissions;
...
-- Drop existing procedure if it exists
DROP PROCEDURE IF EXISTS mir_update;
...
-- Drop existing procedure if it exists
DROP PROCEDURE IF EXISTS mir_update_cmnform;
...
-- Drop existing procedure if it exists
DROP PROCEDURE IF EXISTS mir_update_customer;
...
-- Drop existing procedure if it exists
DROP PROCEDURE IF EXISTS mir_update_customer_insurance;
...
-- Drop existing procedure if it exists
DROP PROCEDURE IF EXISTS mir_update_doctor;
...
-- Drop existing procedure if it exists
DROP PROCEDURE IF EXISTS mir_update_facility;
...
-- Drop existing procedure if it exists
DROP PROCEDURE IF EXISTS mir_update_insurancecompany;
...
-- Drop existing procedure if it exists
DROP PROCEDURE IF EXISTS mir_update_order;
...
-- Drop existing procedure if it exists
DROP PROCEDURE IF EXISTS mir_update_orderdetails;
...
-- Drop existing procedure if it exists
DROP PROCEDURE IF EXISTS move_serial_on_hand;
...
-- Drop existing procedure if it exists
DROP PROCEDURE IF EXISTS Order_ConvertDepositsIntoPayments;
...
-- Drop existing procedure if it exists
DROP PROCEDURE IF EXISTS Order_InternalProcess;
...
-- Drop existing procedure if it exists
DROP PROCEDURE IF EXISTS Order_InternalUpdateBalance;
...
-- Drop existing procedure if it exists
DROP PROCEDURE IF EXISTS order_process;
...
-- Drop existing procedure if it exists
DROP PROCEDURE IF EXISTS order_process_2;
...
-- Drop existing procedure if it exists
DROP PROCEDURE IF EXISTS order_update_dos;
...
-- Drop existing procedure if it exists
DROP PROCEDURE IF EXISTS process_reoccuring_order;
...
-- Drop existing procedure if it exists
DROP PROCEDURE IF EXISTS process_reoccuring_purchaseorder;
...
-- Drop existing procedure if it exists
DROP PROCEDURE IF EXISTS PurchaseOrder_UpdateTotals;
...
-- Drop existing procedure if it exists
DROP PROCEDURE IF EXISTS retailinvoice_addpayments;
...
-- Drop existing procedure if it exists
DROP PROCEDURE IF EXISTS serials_fix;
...
-- Drop existing procedure if it exists
DROP PROCEDURE IF EXISTS serials_po_refresh;
...
-- Drop existing procedure if it exists
DROP PROCEDURE IF EXISTS serials_refresh;
...
-- Drop existing procedure if it exists
DROP PROCEDURE IF EXISTS serial_add_transaction;
...
-- Drop existing procedure if it exists
DROP PROCEDURE IF EXISTS serial_order_refresh;
...
-- Drop existing procedure if it exists
DROP PROCEDURE IF EXISTS serial_transfer;
